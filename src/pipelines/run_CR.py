...
from scrapers.civique_cr_scraper import CiviqueCRScraper


RAW_PATH = Path("data/raw/cr_questions_raw.json")
PROCESSED_PATH = Path("data/processed/cr_questions_processed.csv")
